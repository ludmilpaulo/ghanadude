...
PAYFAST_RETURN_URL = env(
    "PAYFAST_RETURN_URL", default="https://www.payfast.co.za/return/success"
)
PAYFAST_CANCEL_URL = env(
    "PAYFAST_CANCEL_URL", default="https://www.payfast.co.za/return/cancel"
)
PAYFAST_NOTIFY_URL = env(
    "PAYFAST_NOTIFY_URL",
    default="https://your-real-domain-or-ngrok-url/order/payfast/payment-notify/",
)
