...
const PaymentHistory: React.FC<Props> = ({ payments }) => (
  <div className="space-y-4">
    {payments.map((payment) => (
      <div key={payment.id} className="bg-white shadow p-4 rounded-xl flex justify-between items-center">
        <div>
        ...
        <a href={payment.invoice} target="_blank" className="text-blue-500 hover:underline">
